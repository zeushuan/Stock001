...
- ⭐ **MARGUP 毛利率 YoY**（v3 突破，344 檔 25% 覆蓋）→
  進攻 0.68→0.72、平衡 0.85→**0.93**、極致風控 1.03→1.04
  **25+ 變體研究中第一次淨正面改善**（待補完 73% 樣本驗證）
...
12. **MARGUP 毛利率 YoY 是首個有效基本面信號**：質（毛利率）比量（月營收）更領先；進攻/平衡/極致風控 3 風格風報比全部上升
...
| **+MARGUP（毛利率 YoY）⭐** | **進攻+0.04 / 平衡+0.08 / 極致+0.01** | ✅ |
