...
⑦ 自適應趨勢 v7（2026-04-26 最終版）：
  ...
  全市場 1263 檔回測平均：+72.79%

  v8 嘗試（已全部回滾，v7 仍為最佳）：
    - W-Bottom 過濾：全市場 +69.8% 反劣於 v7 +72.3%
    - 冷卻期 / 連敗淘汰：誤殺 4961 天鈺 -666%
    - T1 ADX/EMA120 過濾：殺真趨勢轉變（元晶 -516）
    - EMA20 跟蹤停損：6139 亞翔 -1992%（切碎主升段）
    - 時間停損 T30：23檔抽樣 +1，全市場 -2.59%（誤殺慢起步贏家）
    - 信號分級部位（C）：6443/3017 縮水嚴重
  結論：v7 已達進場/出場過濾的局部最佳解，再優化需要架構性改變
        （複利、持倉組合、不同時間框架）
"""
